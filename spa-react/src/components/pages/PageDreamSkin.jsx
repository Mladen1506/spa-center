    ...
    <Page>
      <PageContent>
        <div className="fl-rich-text">
          ...
          <p>Arnica, a botanical belonging to the sunflower family. It is touted for its anti-inflammatory properties, and is often used to reduce swelling, redness and bruising. Arnica is the ingredient that gives this facial its calming effect.</p>
          <h3></h3>
          <h3>Pricing</h3>
