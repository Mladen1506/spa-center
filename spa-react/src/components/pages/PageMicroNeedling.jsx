    ...
    <Page>
      <PageContent>
        <div class="fl-rich-text">
          <h3>Pen Precision Micro-Needling</h3>
          <ul>
          ...
          <h6>Special Pricing for a Limited Time!</h6>
          <p>Special Single session pricing: <strong>$380</strong> <span>( Reg Price $550)</span></p>
          <p>Package of 3: $990 expires after 6 months</p>
          <p>Package of 6: $1800 expires after 12 months</p>
        </div>
      </PageContent>
    </Page>
  );
