    ...
    <Page>
      <PageContent>
        <div className="fl-rich-text">
          <h6>Signature HydraFacial Body Treatments</h6>
          ...
          <h6>Neck and Décolleté (10 min.)</h6>
          ...
          <h6>HydraFacial LED Light Therapy</h6>
          ...
          <h6>Face (Red and Blue LED at the same time)</h6>
          <ul>
            <li>Stand-alone price $75</li>
            <li>Add-on price with Signature HydraFacial $50</li>
          </ul>
