    ...
    <Page>
      <PageContent>
        <div className="fl-rich-text">
          ...
          <p><span className="pricing-text">Single Session $650 </span></p>
          <p><span className="pricing-text">Limited Time Special Package Pricing:</span></p>
          <p><span className="pricing-text">4 Sessions $1800</span></p>
          <p><span className="pricing-text">6 Sessions $2400</span></p>
          <p>&nbsp;</p>
          <p><span className="pricing-text"><strong>To treat acne skin conditions:</strong></span></p>
          <p><span className="pricing-text">Aqua Gold - Acne Treatment </span><span className="pricing-text">Special Package Pricing: </span></p>
          <p><span className="pricing-text">8 Sessions $2000</span></p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
