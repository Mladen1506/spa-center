    ...
    <Page>
      <PageContent>
        <div className="fl-rich-text">
          <p>
            <Image wide src={"/static/img/pages/aquagold-logo-no-micro_360x-300x57.png"} alt="AquaGold" />
          </p>
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p><a href="https://aquagoldfinetouch.com/"><Image wide src={"/static/img/pages/aquagold-logo-no-micro_360x-300x57.png"} alt="AquaGold" /></a></p>
        </div>
      </PageContent>
    </Page>
  );
