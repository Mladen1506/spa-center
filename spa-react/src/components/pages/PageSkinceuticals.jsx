      ...
      <PageContent>
        <div className="fl-rich-text">
          ...
          <ul>
            ...
            <li>removes pigment spots</li>
            <li>treats melasma</li>
          </ul>
          <p>This treatment may take 5 to 7 days to heal. This treatment may be done every 2 to 4 months.</p>
          <p>&nbsp;</p>
          <p><b>Single Treatment: $350</b></p>
          <p><b>Package of 3: $900</b></p>
          <p><b>TCA Peel with Facial: $425</b></p>

          <h3>Micropeel 30 - Glycolic Peel</h3>
          ...
          <p>4-6 treatments are recommended every 4 weeks to obtain desired results.</p>
          <p>&nbsp;</p>
          <p><b>Single Treatment: $250</b></p>
          <p><b>Package of 3: $660</b></p>
          <p><b>Micropeel 30 with Facial: $325</b></p>

          <h3>Micropeel Plus - Salicylic Peel</h3>
          ...
          <ul>
            ...
            <li>refines pore size appearance</li>
            <li>improves skin texture</li>
          </ul>
          <p>Treatments should be done every 2 weeks during the corrective stage of the program, and 4-6 treatments are recommended to obtain desired and realistic results.</p>
          <p>&nbsp;</p>
          <p><b>Single Treatment: $250</b></p>
          <p><b>Package of 3: $660</b></p>
          <p><b>Micropeel Plus with Facial: $325</b></p>
        </div>
      </PageContent>
    </Page>
  );
};
export default PageSkinceuticals;